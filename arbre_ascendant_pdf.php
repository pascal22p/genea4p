...
$pdf->text($x+$largeur1*2+$largeur2,$y+$hauteur*33+4,(isset($g4p_resultat['MFFM']['date']))?($g4p_resultat['MFMF']['date']):(''));
...
$pdf->Output('arbre '.$g4p_indi->nom.' '.$g4p_indi->prenom.".pdf",true);
